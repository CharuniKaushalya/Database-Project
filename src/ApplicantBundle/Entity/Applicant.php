...
class Applicant
{
     ...
     * Add markingScheme
     *
     * @param \ApplicantBundle\Entity\MarkingScheme $markingScheme
     *
     * @return Applicant
     */
    public function addMarkingScheme(\ApplicantBundle\Entity\MarkingScheme $markingScheme)
    {
     ...
     * @param \ApplicantBundle\Entity\MarkingScheme $markingScheme
     */
    public function removeMarkingScheme(\ApplicantBundle\Entity\MarkingScheme $markingScheme)
    {
