...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'db_project', 'user' => 'root', 'password' => 'bit', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    {
        $a = new \Doctrine\ORM\Mapping\Driver\SimplifiedXmlDriver(array(($this->targetDirs[3].'\\src\\ApplicantBundle\\Resources\\config\\doctrine') => 'ApplicantBundle\\Entity', ($this->targetDirs[3].'\\src\\ApplicationBundle\\Resources\\config\\doctrine') => 'ApplicationBundle\\Entity'));
        $a->setGlobalBasename('mapping');

        $b = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $b->addDriver($a, 'ApplicantBundle\\Entity');
        $b->addDriver($a, 'ApplicationBundle\\Entity');

        $c = new \Doctrine\ORM\Configuration();
        $c->setEntityNamespaces(array('ApplicantBundle' => 'ApplicantBundle\\Entity', 'ApplicationBundle' => 'ApplicationBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_39728bf1071fd6303313e04a5a13df66d5339389e6f9bbd9d02be851276d23d7');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\ApplicantBundle/Resources/views'), 'Applicant');
        $instance->addPath(($this->targetDirs[3].'\\src\\ApplicationBundle/Resources/views'), 'Application');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('765445c8151b0c8a0fd9037437a9df7f45b68060');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('56801e2c0c9799.58086256')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'ApplicantBundle' => 'ApplicantBundle\\ApplicantBundle',
                'ApplicationBundle' => 'ApplicationBundle\\ApplicationBundle',
            ...
            'database_user' => 'root',
            'database_password' => 'bit',
            'mailer_transport' => 'smtp',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => NULL,
            'mailer_password' => NULL,
            'secret' => '765445c8151b0c8a0fd9037437a9df7f45b68060',
            'locale' => 'en',
            ...
            'kernel.secret' => '765445c8151b0c8a0fd9037437a9df7f45b68060',
