 ...
 */
class Marks extends \ApplicantBundle\Entity\Marks implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'ApplicantBundle\\Entity\\Marks' . "\0" . 'type', '' . "\0" . 'ApplicantBundle\\Entity\\Marks' . "\0" . 'mark', '' . "\0" . 'ApplicantBundle\\Entity\\Marks' . "\0" . 'id', '' . "\0" . 'ApplicantBundle\\Entity\\Marks' . "\0" . 'markingScheme');
        }
